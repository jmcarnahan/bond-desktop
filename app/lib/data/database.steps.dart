...
class Shape22 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get clusterHash =>
      columnsByName['cluster_hash']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get refreshedMemberHash =>
      columnsByName['refreshed_member_hash']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get refreshedMemberCount =>
      columnsByName['refreshed_member_count']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get charterSuggestion =>
      columnsByName['charter_suggestion']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get recapText =>
      columnsByName['recap_text']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get recapOpenJson =>
      columnsByName['recap_open_json']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get recapDecisionsJson =>
      columnsByName['recap_decisions_json']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get recapThrough =>
      columnsByName['recap_through']! as i1.GeneratedColumn<String>;
}
...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape23 messages = Shape23(
    source: i0.VersionedTable(
      entityName: 'messages',
      withoutRowId: false,
      isStrict: true,
...
class Shape25 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get isInline =>
      columnsByName['is_inline']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get contentId =>
      columnsByName['content_id']! as i1.GeneratedColumn<String>;
  ...
  i1.GeneratedColumn<String> get cardText =>
      columnsByName['card_text']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get itemSubject =>
      columnsByName['item_subject']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get itemFrom =>
      columnsByName['item_from']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get itemReceived =>
      columnsByName['item_received']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get textStatus =>
      columnsByName['text_status']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get textReason =>
      columnsByName['text_reason']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get textTruncated =>
      columnsByName['text_truncated']! as i1.GeneratedColumn<int>;
  ...
  i1.GeneratedColumn<String> get blobPath =>
      columnsByName['blob_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get blobSha256 =>
      columnsByName['blob_sha256']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get blobFetchedAt =>
      columnsByName['blob_fetched_at']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get thumbPath =>
      columnsByName['thumb_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get pinnedStorylineId =>
      columnsByName['pinned_storyline_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get createdAt =>
      columnsByName['created_at']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get updatedAt =>
      columnsByName['updated_at']! as i1.GeneratedColumn<String>;
...
i1.GeneratedColumn<String> _column_136(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'file\''),
    );
...
class Shape28 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get blockedAt =>
      columnsByName['blocked_at']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get blockedBy =>
      columnsByName['blocked_by']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get evidence =>
      columnsByName['evidence']! as i1.GeneratedColumn<String>;
}
